...
https://github.com/user-attachments/assets/3a23ced0-2361-4c12-8af0-93fcecd1f1d9

- 異常系（ユーザー名がない場合）

https://github.com/user-attachments/assets/21dc285f-29f9-42ed-bdbe-07e611c6a9da
...
- ユーザー名が空文字や null の場合は HTTP ステータス 422 を返す
- ユーザー識別子が期待していない値（詳細は [データベース](#データベース) 章を参照）でリクエストされた場合は HTTP ステータス 422 を返す
- パスワードが期待していない値（詳細は [データベース](#データベース) 章を参照）でリクエストされた場合は HTTP 422 を返す
